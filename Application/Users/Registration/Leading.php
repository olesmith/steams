...
class UsersRegistrationLeading extends UsersRegistrationTrailing
{
    ...
    {
        if (empty($this->RegistrationSystemPaths))
        {
            $this->RegistrationSystemPaths=
                array
                (
                    $this->ApplicationObj()->MyApp_Setup_Root().
                    "/Application/System/Users/Registration"
                );
        }
        ...
        foreach ($this->RegistrationSystemPaths as $path)
        {
            ...
            var_dump($this->ApplicationObj()->MyApp_Setup_Path());
            return "ReadRegistrationTable: No such ".$rfile;
        }

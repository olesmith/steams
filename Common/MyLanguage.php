...
include_once("MyLanguage/File.php");
include_once("MyLanguage/Messages.php");
include_once("MyLanguage/Message.php");
...
trait MyLanguage
{
    ...
    //*
    //* function MyLanguages_Languages, Parameter list: 
    //*
    //* 
    //*

    function MyLanguage_Languages()
    {
        
        return $this->ApplicationObj()->DBHash[ "Languages" ];
    }
    ...
    function MyLanguage_Init()
    {
        ...
        foreach ($this->MyLanguage_Languages() as $language)
        {
            $this->ApplicationObj()->Languages[ $language ]=
                $languages[ $language ];
        }
    ...
    //*
    //* function LanguageRKey, Parameter list: 
    //*
    //* 
    //*

    function LanguageRKey()
    {
        $lkey=$this->LanguageKey();
        if (!empty($lkey)) { $lkey="_".$lkey; }
    ...
    function MyLanguage_Detect()
    {
        ...
        if (empty($language))
        {
            $language=$this->ApplicationObj()->Language;
        }
    ...
    {
        $this->ApplicationObj->Language=$language;
        $this->ApplicationObj->Messages=array();
    }
    ...
    function MyLanguage_GetLanguageKey($language="")
    {
        ...
        if (empty($this->ApplicationObj()->Languages[ $language ]))
        {
            return "";
        }
    ...
    function MyLanguage_Message_Add($key,$message,$type=1,$item=array())
    {

        return
            $this->LanguagesObj()->Language_Message_Add
            (
                $key,$message,
                $this->ModuleName,
                $type=1,$item

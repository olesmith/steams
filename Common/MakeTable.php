...
{
    //*
    //* function List_Unique, Parameter list: $list
    //*
    //* Removes doubly defined items
    //*
    ...
    function Table_Defaults($rargs)
    {
        ...
        if (!empty($group))
        {
            ...
            {
                $this->Args[ "Actions" ]=array_merge
                (
                   $this->Args[ "Actions" ],
                   $this->ItemDataGroups[ $group ][ "Actions" ]
                );
                $this->Args[ "Actions" ]=$this->List_Unique($this->Args[ "Actions" ]);
            }
            ...
            if (!empty($this->ItemDataGroups[ $group ][ "ShowData" ]))
            {
                ...
                $this->Args[ "ShowDatas" ]=$this->List_Unique($this->Args[ "ShowDatas" ]);
            }
            ...
            if (!empty($this->ItemDataGroups[ $group ][ "Data" ]))
            {
                ...
                $this->Args[ "Datas" ]=$this->List_Unique($this->Args[ "Datas" ]);
            }
        }
    }

...
trait MyApp_Messages_Edit
{
    ...
    function FixedFiles()
    {
        $basepath=$this->MyApp_Setup_Path();
        return
            array
            (
                $basepath."/MySql2/Actions/Actions.php" => array("Name","Title","ShortName"),
                $basepath."/System/Modules.php" => array("ItemName","ItemsName"),
                $basepath."/System/Profiles.php" => array("Name","PName"),
                $basepath."/System/LeftMenu.php" => array("Name","Title"),
            );
    }

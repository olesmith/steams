...
trait Sql_Select_Values
{
    ...
    function Sql_Select_Hash_Values($id,$vars,$idvar="ID",$noecho=FALSE,$table="")
    {
        return
            ...
            (
                $this->Sql_Select_Hash_Value_Where($id,$idvar),
                $vars,
                FALSE,
                $table
            );
    ...
    //*
    //* If $id is array, use it as where.
    //* If not create basic $where.
    //* 

    function Sql_Select_Hash_Value_Where($id,$idvar)
    {
        $where=$id;
        if (!is_array($id))
        {
            $where=array($idvar => $id);
        }
    ...
    function Sql_Select_Hash_Value_Query($id,$var,$idvar="ID",$noecho=FALSE,$table="")
    {
        return

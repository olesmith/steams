...
trait Sql_Table
{
    ...
    //*
    //* function Sql_Table_Create_If_Non_Existent, Parameter list: $table
    //*
    //* Creates module table if non existent.
    //*

    function Sql_Table_Create_If_Non_Existent()
    {
        if (!$this->Sql_Table_Exists($this->SqlTableName()))
        {
            var_dump("Module ".$this->ModuleName." creating table: ".$this->SqlTableName());

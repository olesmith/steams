...
trait ItemsFormAdd
{
    ...
    function ItemsForm_AddRows()
    {
        ...
        if (count($this->ItemsForm_AddMessages_Has()))
        {
            $rows=array_merge
            (
               $rows,
    ...
    function ItemsForm_AddItem()
    {
        ...
        $add=TRUE;
        $add=
            $this->ItemsForm_AddItemMissingData($newitem)
            &&
            $this->ItemsForm_AddItemTestUniqueData($newitem);
        ...
        {
            $this->ItemsForm_AddMessage("Not added.");            
        }
   }

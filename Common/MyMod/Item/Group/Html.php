...
trait MyMod_Item_Group_Html
{
    ...
    function MyMod_Item_Group_Tables_Html($redit,$groupdefs,$item,$buttons="",$plural=FALSE,$options=array(),$troptions=array(),$tdoptions=array())
    {
        if (empty($options))
        {
            $options=

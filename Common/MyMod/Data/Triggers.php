    ...
    function MyMod_Data_Trigger_Apply($data,$item,$prepostkey="",$plural=FALSE)
    {
        ...
        if ($method)
        {
            if (method_exists($this,$method))
            {
                ...
                $newvalue=$this->CGI_POST($prepostkey.$rdata);
                $ritem=$this->$method($item,$data,$newvalue,$prepostkey);
            ...
            else
            {
                die
                (
                    "Warning: ($data) TriggerFunction: ".
                    "\$item= $method(\$item,\$data,\$newvalue,\$prepostkey): ".
                    "undefined"
                );
            }
        }

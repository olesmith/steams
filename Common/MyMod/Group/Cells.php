...
trait MyMod_Group_Cells
{
    ...
    function MyMod_Group_Cell_Data($edit,$item,$data,$value="",$even=False,$tabindex=0)
    {
        ...
        return $this->MyMod_Data_Cell_Align($data,$value);
    }
    ...
    function MyMod_Data_Cell_Aligned($value,$align)
    {
        if (!empty($align))
        {
            $value=
    ...
    function MyMod_Data_Cell_Align($data,$value)
    {
        if (!empty($this->ItemData[ $data ]))
        {
            ...
            $value=$this->MyMod_Data_Cell_Aligned($value,$align);
        }

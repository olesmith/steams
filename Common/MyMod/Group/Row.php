...
trait MyMod_Group_Row
{
    ...
    function MyMod_Group_Row_Item($edit,$item,$nn,$datas,$even=TRUE,$prekey="")
    {
                ...
                else
                {
                    $value=
                        ...
                        (
                            ...
                            $plural=True,
                            $tabindex="",
                            $rdata=$prekey.$item[ "ID" ]."_".$data,
                            $even
                        );
                }
            }

            //20191024: Creates problems??
            $value=$this->MyMod_Data_Cell_Align($data,$value);

...
function HTMLMakeRow($row,$tdtag="TD",$number=0,$count=0,$tdclass="",$troptions=array())
{
    ...
    $html="   <TR".$this->Htmls_Options_String($troptions).">\n";
    ...
    for ($n=0;$n<count($row);$n++)
    {
        ...
        {
            $tdtag.=$this->Htmls_Options_String($tdoptions);
        ...
        $html.=
            ...
            $tdtag.
            " ".
            $this->Htmls_Options_String($roptions).">\n".
            $row[$n].
            "</".$tddtag.">\n";
    }
...
function HTMLTable($titles,$rows,$tableoptions=array(),$background=TRUE,$tdclass="")
{
    ...
    $options=$this->Htmls_Options_String($tableoptions);
